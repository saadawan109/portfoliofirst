...
function TableCreate(){
    ...
    const[limitBy,setLimitBy]=useState(20)
            ...
            <div className="container d-flex flex-column align-items-center">
                ...
                <div className="row justify-content-center">
                    ...
                    <div className="mt-3 d-flex justify-content-around">
                        <div>
                            <button className={`btn btn-sm me-3 ${(orderBy == 'asc')? "btn-warning" : "btn-outline-warning" }`} onClick={()=> setOrderBy("ase")}>ASC</button>
                            <button className={`btn btn-sm ${(orderBy == 'desc')? "btn-warning" : "btn-outline-warning" }`} onClick={()=> setOrderBy("desc")}>DESC</button>
                        </div>
                        <div>
                            <button className={`btn btn-sm me-1  ${(limitBy == 5)? "btn-success" : "btn-outline-success" }`} onClick={()=> setLimitBy(5)}>5</button>
                            <button className={`btn btn-sm me-1  ${(limitBy == 10)? "btn-success" : "btn-outline-success" }`} onClick={()=> setLimitBy(10)}>10</button>
                            <button className={`btn btn-sm me-1  ${(limitBy == 15)? "btn-success" : "btn-outline-success" }`} onClick={()=> setLimitBy(15)}>15</button>
                            <button className={`btn btn-sm me-1  ${(limitBy == 20)? "btn-success" : "btn-outline-success" }`} onClick={()=> setLimitBy(20)}>20</button>
                        </div>
